        ...
        <div className='flex pt-[60px] md:pt-[120px]'>
            <div className='flex flex-row mx-auto'>
                <motion.div initial={{ opacity: 0, translateX: -20 }}
                    ...
                    <img className='w-[300px] h-auto drop-shadow-xl hidden lg:flex'
                ...
                <motion.div className='mt-[30px] ml-[40px]' initial={{ opacity: 0, translateX: 20 }}
                    ...
                    <h1 className='font-rubik text-3xl dark:text-white font-bold mt-[10px] mb-[10px] pr-[60px] md:pr-0'>Want to submit an Artpiece or Artist?</h1>
