...
const FeatureCard: React.FC<FeatureCardProps> = (props) => {
    ...
    return (
        <div className='flex flex-col w-[260px] p-4 border-[2px] dark:border-[#303030] border-[#e6e6e6] rounded-md hover:border-[#FDDD96] group cursor-pointer transition duration-100'>
